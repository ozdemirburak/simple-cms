    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,a[href|title|rel],ul,ol,li,p[style],br,span,img[width|height|alt|src],blockquote,pre,code,table,thead,tbody,tr,th,td,figure,figcaption,hr',
            'HTML.ForbiddenElements' => 'script,style,iframe,form,input,button,select,textarea,object,embed,applet',
            'CSS.AllowedProperties' => 'text-align,text-decoration,padding-left',
